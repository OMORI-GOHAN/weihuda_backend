...
--
-- Host: 127.0.0.1    Database: weihuda
-- ------------------------------------------------------
...
LOCK TABLES `feedback_msg` WRITE;
/*!40000 ALTER TABLE `feedback_msg` DISABLE KEYS */;
/*!40000 ALTER TABLE `feedback_msg` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `jifen_exchange`
--
...
--
-- Dumping data for table `jifen_exchange`
--

LOCK TABLES `jifen_exchange` WRITE;
/*!40000 ALTER TABLE `jifen_exchange` DISABLE KEYS */;
/*!40000 ALTER TABLE `jifen_exchange` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `jifen_goods`
--

LOCK TABLES `jifen_goods` WRITE;
/*!40000 ALTER TABLE `jifen_goods` DISABLE KEYS */;
/*!40000 ALTER TABLE `jifen_goods` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `jifen_records`
--
...
--
-- Dumping data for table `jifen_records`
--

LOCK TABLES `jifen_records` WRITE;
/*!40000 ALTER TABLE `jifen_records` DISABLE KEYS */;
/*!40000 ALTER TABLE `jifen_records` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `jifen_rules`
--
...
--
-- Dumping data for table `jifen_rules`
--

LOCK TABLES `jifen_rules` WRITE;
/*!40000 ALTER TABLE `jifen_rules` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `jifen_rules` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kv_cache`
--
...
--
-- Dumping data for table `kv_cache`
--

LOCK TABLES `kv_cache` WRITE;
/*!40000 ALTER TABLE `kv_cache` DISABLE KEYS */;
/*!40000 ALTER TABLE `kv_cache` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `message_lefts`
--
...
--
-- Dumping data for table `message_lefts`
--

LOCK TABLES `message_lefts` WRITE;
/*!40000 ALTER TABLE `message_lefts` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_lefts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mini_bind`
--
...
--
-- Dumping data for table `mini_bind`
--

LOCK TABLES `mini_bind` WRITE;
/*!40000 ALTER TABLE `mini_bind` DISABLE KEYS */;
/*!40000 ALTER TABLE `mini_bind` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mini_configs`
--
...
--
-- Dumping data for table `mini_configs`
--

LOCK TABLES `mini_configs` WRITE;
/*!40000 ALTER TABLE `mini_configs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `mini_configs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mini_course`
--
...
--
-- Dumping data for table `mini_course`
--
...
--
-- Table structure for table `mini_exam_num`
--
...
--
-- Dumping data for table `mini_exam_num`
--

LOCK TABLES `mini_exam_num` WRITE;
/*!40000 ALTER TABLE `mini_exam_num` DISABLE KEYS */;
/*!40000 ALTER TABLE `mini_exam_num` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `zhihus`
--
...
--
-- Dumping data for table `zhihus`
--

LOCK TABLES `zhihus` WRITE;
/*!40000 ALTER TABLE `zhihus` DISABLE KEYS */;
/*!40000 ALTER TABLE `zhihus` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-02-16 15:51:25
